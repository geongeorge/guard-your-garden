...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -g -O2 -fvisibility=hidden -DDARWIN_NO_CARBON   -I/opt/homebrew/Cellar/brotli/1.0.9/include -pthread \
...
# Linker flags.
#
LDFLAGS :=  -lz -lbz2 -L/opt/homebrew/Cellar/brotli/1.0.9/lib -R/opt/homebrew/Cellar/brotli/1.0.9/lib -lbrotlidec -pthread -lpthread
