...
MKINSTALLDIRS   := /Users/geon/Sandbox/guard-your-garden/depends/freetype-2/builds/unix/./install-sh -c -d
...
PKGCONFIG_REQUIRES         := 
PKGCONFIG_REQUIRES_PRIVATE := zlib, libbrotlidec
PKGCONFIG_LIBS             := -L${libdir} -lfreetype
PKGCONFIG_LIBS_PRIVATE     := -lbz2
LIBSSTATIC_CONFIG          := -lfreetype -lz -lbz2 -L/opt/homebrew/Cellar/brotli/1.0.9/lib -R/opt/homebrew/Cellar/brotli/1.0.9/lib -lbrotlidec -R/opt/homebrew/Cellar/brotli/1.0.9/lib -lbrotlicommon
build_libtool_libs         := 
ft_version                 := 26.0.20
